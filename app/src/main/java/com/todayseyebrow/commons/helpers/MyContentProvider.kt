...
class MyContentProvider {
    companion object {
        private const val AUTHORITY = "com.todayseyebrow.commons.provider"
        const val SHARED_THEME_ACTIVATED = "com.todayseyebrow.commons.SHARED_THEME_ACTIVATED"
        const val SHARED_THEME_UPDATED = "com.todayseyebrow.commons.SHARED_THEME_UPDATED"
