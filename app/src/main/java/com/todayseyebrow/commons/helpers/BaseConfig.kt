package com.todayseyebrow.commons.helpers

import android.content.Context
import android.text.format.DateFormat
import androidx.core.content.ContextCompat
import com.todayseyebrow.commons.R
import com.todayseyebrow.commons.extensions.getInternalStoragePath
import com.todayseyebrow.commons.extensions.getSDCardPath
import com.todayseyebrow.commons.extensions.getSharedPrefs
...
open class BaseConfig(val context: Context) {
    ...
    var appIconColor: Int
        get() = prefs.getInt(APP_ICON_COLOR, ContextCompat.getColor(context, R.color.color_primary))
        set(appIconColor) {
    ...
    var widgetTextColor: Int
        get() = prefs.getInt(WIDGET_TEXT_COLOR, ContextCompat.getColor(context, R.color.color_primary))
